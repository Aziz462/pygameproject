...
class Player(pygame.sprite.Sprite):
    def __init__(self, idle_sheet, run_sheet, columns, rows, x, y):
        ...
        self.cur_frame = 0
        self.run_frames = []
        self.cut_sheet(run_sheet, columns, rows, self.run_frames)
    ...
    def update(self):
        ...
        self.bigger_img = pygame.transform.scale(self.image, (50, 50))
...
player = Player(load_image('knight_idle.png'), load_image('knight_run.png'), 4, 1, 50, 50)
